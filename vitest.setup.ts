...
const translations: Record<string, string> = {
  ...
  'gamePlay.loading.title': 'Loading...',
  ...
  'gamePlay.playersAwardPoints': 'Players - Tap to Award Points',
  ...
  'scoreboard.noPlayers.description': 'This game session has no players.',
